...
describe('workspace policy route inventory', () => {
  it.each<[
    ...
    [WorkersController.prototype, 'getWorkers', WorkspaceAction.WORKER_READ],
    ...
    [WorkspacesController.prototype, 'getWorkspaceMembers', WorkspaceAction.WORKSPACE_READ],
    [WorkspacesController.prototype, 'addWorkspaceMember', WorkspaceAction.MEMBER_MANAGE],
    [WorkspacesController.prototype, 'updateWorkspaceMemberRole', WorkspaceAction.MEMBER_MANAGE],
    [WorkspacesController.prototype, 'removeWorkspaceMember', WorkspaceAction.MEMBER_MANAGE],
