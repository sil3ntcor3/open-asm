...
import { WORKSPACE_POLICY_METADATA } from './workspace-policy.decorator';
...
describe('workspace policy route inventory', () => {
  it.each<[object, string, WorkspaceAction]>([
    [
      TargetsController.prototype,
    ...
    [
      JobsRegistryController.prototype,
      'getManyJobs',
      WorkspaceAction.WORKSPACE_READ,
    ],
    [
    ...
    [
      InternalNetworksController.prototype,
    ...
    [
      AssetGroupController.prototype,
