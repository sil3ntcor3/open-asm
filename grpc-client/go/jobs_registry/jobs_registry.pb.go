...
// Enum value maps for JobControlAction.
var (
	JobControlAction_name = map[int32]string{
		0: "JOB_CONTROL_NONE",
		1: "JOB_CONTROL_STOP",
		2: "JOB_CONTROL_PAUSE",
		3: "JOB_CONTROL_RESUME",
	}
	JobControlAction_value = map[string]int32{
		"JOB_CONTROL_NONE":   0,
		"JOB_CONTROL_STOP":   1,
		"JOB_CONTROL_PAUSE":  2,
...
func (x JobControlAction) Enum() *JobControlAction {
	p := new(JobControlAction)
	*p = x
	return p
}

func (x JobControlAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (JobControlAction) Descriptor() protoreflect.EnumDescriptor {
	return file_jobs_registry_proto_enumTypes[0].Descriptor()
}

func (JobControlAction) Type() protoreflect.EnumType {
	return &file_jobs_registry_proto_enumTypes[0]
}

func (x JobControlAction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use JobControlAction.Descriptor instead.
func (JobControlAction) EnumDescriptor() ([]byte, []int) {
...
type ControlRequest struct {
	...
	ActiveJobIds  []string `protobuf:"bytes,2,rep,name=active_job_ids,json=activeJobIds,proto3" json:"active_job_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ControlRequest) GetWorkerId() string {
	if x != nil {
		return x.WorkerId
	}
	return ""
...
func (x *ControlRequest) GetActiveJobIds() []string {
	if x != nil {
...
type JobDirective struct {
	...
	Action        JobControlAction       `protobuf:"varint,2,opt,name=action,proto3,enum=jobs_registry.JobControlAction" json:"action,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *JobDirective) GetJobId() string {
	if x != nil {
		return x.JobId
	}
	return ""
...
func (x *JobDirective) GetAction() JobControlAction {
	if x != nil {
		return x.Action
	}
	return JobControlAction_JOB_CONTROL_NONE
}

type ControlResponse struct {
	state      protoimpl.MessageState `protogen:"open.v1"`
	Directives []*JobDirective        `protobuf:"bytes,1,rep,name=directives,proto3" json:"directives,omitempty"`
	...
	DispatchPaused bool `protobuf:"varint,3,opt,name=dispatch_paused,json=dispatchPaused,proto3" json:"dispatch_paused,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ControlResponse) GetDirectives() []*JobDirective {
	if x != nil {
		return x.Directives
	}
	return nil
...
func (x *ControlResponse) GetMaxConcurrency() int32 {
	if x != nil {
...
func (x *ControlResponse) GetDispatchPaused() bool {
	if x != nil {
...
const file_jobs_registry_proto_rawDesc = "" +
	...
	"\x0eactive_job_ids\x18\x02 \x03(\tR\factiveJobIds\"^\n" +
	"\fJobDirective\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x127\n" +
	"\x06action\x18\x02 \x01(\x0e2\x1f.jobs_registry.JobControlActionR\x06action\"\xa0\x01\n" +
	...
	"\atool_id\x18\x04 \x01(\tR\x06toolId*m\n" +
	"\x10JobControlAction\x12\x14\n" +
	...
	"\bCRITICAL\x10\x042\xd9\x01\n" +
	"\x13JobsRegistryService\x121\n" +
	"\x04Next\x12\x15.jobs_registry.Worker\x1a\x12.jobs_registry.Job\x12E\n" +
	"\x06Result\x12\x1f.jobs_registry.JobResultRequest\x1a\x1a.jobs_registry.JobResponse\x12H\n" +
	"\aControl\x12\x1d.jobs_registry.ControlRequest\x1a\x1e.jobs_registry.ControlResponseB\x11Z\x0f./jobs_registryb\x06proto3"
